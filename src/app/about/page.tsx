  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-6 py-20">
      ...
      <div className="mx-auto max-w-3xl w-full">
        ...
        <div className="rounded-2xl bg-[#D1CCC7]/95 p-8 shadow-md hover:shadow-lg transition duration-300 ring-1 ring-white/20 backdrop-blur">
          
          <h1 className="text-4xl font-semibold tracking-tight text-slate-900">
            About
          </h1>

          <div className="mt-6 space-y-6 text-slate-800 leading-relaxed">
            <p>
